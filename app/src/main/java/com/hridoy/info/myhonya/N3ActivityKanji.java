...
public class N3ActivityKanji extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N3 Kanji");
        setContentView(R.layout.activity_n3_kanji);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=129vPnDbsRgSh2Pcd3Lf752UNKrA0PkXv&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N3ActivityKanji.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
