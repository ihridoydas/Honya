...
public class N1ActivityBunpou extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N1 GOI");
        setContentView(R.layout.activity_n1_bunpou);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=1AKaT0BLuZ7GnosLTm2EcZqZ7PebXprxB&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N1ActivityBunpou.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
