...
public class KanjiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Minna No NihonGo(Kanji)");
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=1Eha_RcljeaoCS_y3OXEcP063pBBT0qT1&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(KanjiActivity.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
