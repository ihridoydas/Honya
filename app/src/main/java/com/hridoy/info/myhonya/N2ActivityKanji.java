...
public class N2ActivityKanji extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N2 Kanji");
        setContentView(R.layout.activity_n2_kanji);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=10PDSc_lt1pmDnQRrAI1StuN5212TbjOC&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N2ActivityKanji.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
