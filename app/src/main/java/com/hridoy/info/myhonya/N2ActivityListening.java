...
public class N2ActivityListening extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N2 Listening");
        setContentView(R.layout.activity_n2_listening);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=1bRt0ZILrytFCLE3VPgZaSWJgkZpCrUfP&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N2ActivityListening.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
