...
public class N1ActivityKanji extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N1 Kanji");
        setContentView(R.layout.activity_n1_kanji);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=18Qm1SnDJ-d8zbvlKIwqbNHPDmPjpxUSH&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N1ActivityKanji.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
