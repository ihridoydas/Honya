...
public class N3ActivityBunpou extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("N3 Grammer");
        setContentView(R.layout.activity_n3_bunpou);
        ...
        FileLoader.with(this)
                .load("https://drive.google.com/uc?authuser=0&id=1zgUsg721J77VKTPTG43KhwLngtkn7ef5&export=download")
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onError(FileLoadRequest fileLoadRequest, Throwable throwable) {
                        ...
                        Toast.makeText(N3ActivityBunpou.this,""+throwable.getMessage(),Toast.LENGTH_LONG).show();
